...
getwd()
#---read dataset------
example_df<-read.csv("/Users/ajisafeadediwura/Desktop/Practical class 3-20250513/distribution.csv", header = TRUE,dec = ',', sep = ";")
factor_df <- read.csv("/Users/ajisafeadediwura/Desktop/Practical class 3-20250513/factor_data.csv")
imputed_df <- read.csv("/Users/ajisafeadediwura/Desktop/Practical class 3-20250513/imputed_data.csv")
